...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    'nav.rate_calculator': 'GST Rate Calculator',
  ...
  hi: {
    ...
    'nav.refunds': 'आईटीसी रिफंड (Refunds)',
    'nav.reports': 'रिपोर्ट',
    ...
    'Invoice Number': 'चालान संख्या (Invoice Number)',
    'Date': 'तारीख (Date)',
  ...
  gu: {
    ...
    'nav.rate_calculator': 'જીએસટી દર કેલ્ક્યુલેટર',
    'nav.computation': 'ટેક્સ એન્જિન',
    'nav.reconciliation': 'સમાધાન (Reconciliation)',
    'nav.data_quality': 'ડેટા ગુણવત્તા',
  ...
  mr: {
    ...
    'nav.rate_calculator': 'जीएसटी दर कॅल्क्युलेटर',
    ...
    'nav.refunds': 'आयटीसी परतावा (Refunds)',
    'nav.reports': 'अहवाल',
  ...
  ta: {
    ...
    'nav.rate_calculator': 'ஜிஎஸ்டி விகித கால்குலேட்டர்',
    'nav.computation': 'வரி இயந்திரம்',
    'nav.reconciliation': 'நல்லிணக்கம்',
    'nav.data_quality': 'தரக் கட்டுப்பாடு',
    ...
    'nav.refunds': 'ஐடிசி திரும்பப்பெறுதல்',
  ...
  te: {
    ...
    'nav.rate_calculator': 'జీఎస్టీ రేటు కాలిక్యులేటర్',
    'nav.computation': 'పన్ను ఇంజిన్',
    'nav.reconciliation': 'రాజీ (Reconciliation)',
    'nav.data_quality': 'డేటా నాణ్యత',
    ...
    'Invoice Number': 'ఇన్‌వాయిస్ సంఖ్య',
    'Date': 'తేదీ',
    'Customer': 'కస్టమర్',
    'Amount': 'మొత్తం',
    'Tax': 'పన్ను',
